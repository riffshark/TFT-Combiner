...
let recipeBF = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Shimmerscale],
...
let recipeBow = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Ragewing],
...
let recipeRod = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Dragonmancer],
...
let recipeTear = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Mage],
...
let recipeChainWest = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Cavalier],
...
let recipeNegatron = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Mirage],
...
let recipeGiantsBelt = new Map([
    ...
    [ITEMS.Spatula, ITEMS.Emblem_Guardian],
    [ITEMS.Sparring_Gloves, ITEMS.Banshees_Claw],
]);

let recipeSpatula = new Map([
    [ITEMS.BF, ITEMS.Emblem_Shimmerscale],
    [ITEMS.Bow, ITEMS.Emblem_Ragewing],
    [ITEMS.Rod, ITEMS.Emblem_Dragonmancer],
    [ITEMS.Tear, ITEMS.Emblem_Mage],
    [ITEMS.Chain_West, ITEMS.Emblem_Cavalier],
    [ITEMS.Negatron, ITEMS.Emblem_Mirage],
    [ITEMS.Giants_Belt, ITEMS.Emblem_Guardian],
...
let ITEM_DESCRIPTION = new Map([
    ...
    [ITEMS.Emblem_Dragonmancer, "Emblem_Dragonmancer"],
    [ITEMS.Emblem_Assassin, "Emblem_Assassin"],
    [ITEMS.Emblem_Bruiser, "Emblem_Bruiser"],
    [ITEMS.Emblem_Ragewing, "Emblem_Ragewing"],
    [ITEMS.Emblem_Guardian, "Emblem_Guardian"],
    [ITEMS.Emblem_Clockwork, "Emblem_Clockwork"],
    [ITEMS.Emblem_Cavalier, "Emblem_Cavalier"],
    [ITEMS.Emblem_Enforcer, "Emblem_Enforcer"],
    [ITEMS.Emblem_Mage, "Emblem_Mage"],
    [ITEMS.Emblem_Innovator, "Emblem_Innovator"],
    [ITEMS.Emblem_Mercenary, "Emblem_Mercenary"],
    [ITEMS.Emblem_Mirage, "Emblem_Mirage"],
    ...
    [ITEMS.Emblem_Shimmerscale, "Emblem_Shimmerscale"],
...
let ITEM_DESCRIPTION_FULL = new Map([
    ...
    [ITEMS.Emblem_Dragonmancer, "The holder gains the Dragonmancer trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Assassin, "The holder gains the Assassin trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Bruiser, "The holder gains the Bruiser trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Ragewing, "The holder gains the Ragewing trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Guardian, "The holder gains the Guardian trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Clockwork, "The holder gains the Clockwork trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Cavalier, "The holder gains the Cavalier trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Enforcer, "The holder gains the Enforcer trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Mage, "The holder gains the Mage trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Innovator, "The holder gains the Innovator trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Mercenary, "The holder gains the Mercenary trait.\n[Unique - Only One Per Champion]"],
    [ITEMS.Emblem_Mirage, "The holder gains the Mirage trait.\n[Unique - Only One Per Champion]"],
    ...
    [ITEMS.Emblem_Shimmerscale, "The holder gains the Shimmerscale trait.\n[Unique - Only One Per Champion]"],
